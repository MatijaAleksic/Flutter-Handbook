...
class SnackBarExampleMain extends StatelessWidget {
  const SnackBarExampleMain({super.key});
...
class SimpleSnackBarExample extends StatelessWidget {
  const SimpleSnackBarExample({super.key});
...
class CustomSnackBarExample extends StatefulWidget {
  ...
  @override
  State<CustomSnackBarExample> createState() => _SnackBarExampleState();
}

class _SnackBarExampleState extends State<CustomSnackBarExample> {
  ...
  Widget build(BuildContext context) {
    return Column(
        children: <Widget>[
          _padRow(<Widget>[
            const Text('Snack Bar configuration',
                style: TextStyle(
                  fontSize: 20,
                )
            )
          ...
          _padRow(<Widget>[
            const Text('Action new-line overflow'),
            Slider(
              value: _sliderValue,
              divisions: 20,
